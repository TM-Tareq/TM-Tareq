<h1 align="center">Tareq Monowar</h1>

<p align="center">
  Fullstack Developer focused on scalable web applications, realtime systems, and modern user experiences.
</p>
...
- 🌐 Interested in scalable systems, realtime communication & system architecture
- 📚 Currently exploring:
  - System Design
...
- 🎯 Long-term goal:
  Build software products that solve real-world problems at scale.
...
## 🔹 UIU Social Media Platform

A scalable fullstack social media and realtime communication platform designed for university students.
...
## 🔹 AR Supply Chain Simulation Platform

A realtime collaborative supply chain simulation system with AI-driven optimization and visualization.

### Tech Stack

`React` `Node.js` `Socket.IO` `MySQL` `Chart.js`
...
<p align="center">
  <img width="49%" src="https://github-readme-stats.vercel.app/api?username=YOUR_USERNAME&show_icons=true&theme=github_dark&hide_border=true&rank_icon=github" />
...
|---|---|
| ⚛️ Frontend | React Ecosystem & UI Architecture |
| ☕ Backend | Spring Boot & REST APIs |
| 🌐 Realtime Systems | WebSocket & Socket.IO |
| 🧠 Computer Science | System Design & DSA |
| 🚀 Goal | Building Production-Level Applications |
...
<p>
  <a href="https://www.linkedin.com/in/tareq-monowar-099aa72a3/">
...
<p align="center">
  <i>“Great software is built through consistency, not motivation.”</i>
</p>
